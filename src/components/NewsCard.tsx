...
function NewsCard({article}: {article: any}) {
  ...
  return (
    <div key={article.id} className="border p-4 mb-4 rounded flex">
        <div className=''>
            <img src={article.thumbnail || "/image.png"} alt="Article Image" onError={(e) => e.currentTarget.src = "/image.png"} className="w-48 h-34 lg:w-56 lg:h-40 object-cover rounded mr-4 shrink-0" />
        </div>
